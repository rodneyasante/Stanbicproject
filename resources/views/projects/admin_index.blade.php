		                ...
		                <tbody>
		                    ...
		                    <tr>
		                        ...
		                        <td>
			                            ...
			                            <a class="publish" href="{{route('projects.publish', $project)}}" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="publish">publish</i></a>
		                        </td>
		                    </tr>
		                    @endforeach
		                </tbody>
...
function addTask(e) {
  ...
  var form = $(".schedule__form");
  var check = form.hasClass('show');
